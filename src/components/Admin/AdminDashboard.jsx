            ...
            <div className="flex gap-4 flex-col sm:flex-row flex-grow">
                <div className="flex justify-between bg-white shadow-md p-8 w-full sm:w-1/3 rounded-lg">
                    <div className="">
                        ...
                        <h2 className="text-4xl text-transparent font-bold bg-gradient-to-tl from-blue-800 to-teal-400 bg-clip-text">5000</h2>
                    </div>
                    <div className="">
                ...
                <div className="bg-white p-8 w-full sm:w-1/3 rounded-lg shadow-lg">
